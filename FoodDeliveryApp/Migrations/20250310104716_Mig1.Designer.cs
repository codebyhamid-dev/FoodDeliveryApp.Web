            ...
            modelBuilder.Entity("FoodDeliveryApp.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            OrderDateTime = new DateTime(2025, 3, 10, 0, 10, 0, 0, DateTimeKind.Local),
                            Price = 9.99m,
                            Status = 1
                        },
                        new
                        {
                            OrderId = 2,
                            CustomerId = 2,
                            OrderDateTime = new DateTime(2025, 3, 10, 0, 25, 0, 0, DateTimeKind.Local),
                            Price = 7.49m,
                            Status = 2
                        },
                        new
                        {
                            OrderId = 3,
                            CustomerId = 1,
                            OrderDateTime = new DateTime(2025, 3, 10, 0, 32, 0, 0, DateTimeKind.Local),
                            Price = 10.98m,
                            Status = 2
                        },
                        new
                        {
                            OrderId = 4,
                            CustomerId = 2,
                            OrderDateTime = new DateTime(2025, 3, 10, 0, 45, 0, 0, DateTimeKind.Local),
                            Price = 10.99m,
                            Status = 1
                        },
                        new
                        ...
                        new
                        {
                            OrderId = 6,
                            CustomerId = 1,
                            OrderDateTime = new DateTime(2025, 3, 10, 0, 50, 0, 0, DateTimeKind.Local),
                            Price = 10.99m,
                            Status = 3
                        });
                });
